...
fragment Decimal_integer_literal 
  : Decimal_digits Integer_type121_suffix?
  ;
...
fragment DECIMAL_DIGIT 
  : '0'..'9'
  ;
fragment Integer_type121_suffix 
  : 'U'
  | 'u'
  | 'L'
  | 'l'
...
fragment Hexadecimal_integer_literal 
  : ('0x' | '0X') Hex_digits Integer_type121_suffix?
  ;
fragment Hex_digits 
  : HEX_DIGIT+
  ;
...
REAL_LITERAL 
  : Decimal_digits DOT Decimal_digits Exponent_part? Real_type121_suffix?
  | DOT Decimal_digits Exponent_part? Real_type121_suffix?
  | Decimal_digits Exponent_part Real_type121_suffix?
  | Decimal_digits Real_type121_suffix
  ;
